...
//        XiaZi.add(Item.NEW().setAttr(AttrType.Inte, 25 * 3, AttrType.Stre, 9 * 3 + 10 + 15));
        XiaZi.add(Item.NEW().setAttr(AttrType.Inte, 40 * 3 + 75 + 30 + 23 * 12 + 26 * 2, AttrType.Stre, 18 * 3 + 10 + 15, AttrType.Inde, 42 + 45));
...
//                .addNode("魔战_现有", ItemHolder.NEW().add(role).add(getMoZhan()).add(getShouShi()).add(getSanCao())) // 383
                .sort()
                .print();
